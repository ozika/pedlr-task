  ...
  timeline: [
    {
      ...
      stimulus: function(){
        ...
        html += "<p>Remember that this is just the training!<br>Any points you collect during the training <b>WILL NOT COUNT TOWARDS YOUR FINAL SCORE</b>.<br>For now, we just want to teach you what to do!"
        html += "<p><br></p>"
